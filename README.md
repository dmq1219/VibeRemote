...
普通用户不需要安装 Xcode。下载 [VibeRemote.app.zip](https://github.com/dmq1219/VibeRemote/releases/download/v0.1.0/VibeRemote.app.zip)，解压后把 `VibeRemote.app` 拖入 `/Applications` 即可。

当前 Release：[`v0.1.0`](https://github.com/dmq1219/VibeRemote/releases/tag/v0.1.0)

- Universal 构建，支持 Apple Silicon 和 Intel Mac。
- 本版本使用 ad-hoc 签名，未使用 Developer ID 签名，也未公证。
- 如果 macOS 提示无法验证开发者，请到“系统设置 → 隐私与安全性 → 仍要打开”。
- 首次运行仍需要授权“输入监控”和“辅助功能”。
- SHA256：`f418a6453021ad3c1182f7870633ee6da86dc554149d052d2fa14d23c6cc259b`
